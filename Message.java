...
//overrides relying on public getters and setters for JSON processing, enables access to all fields, and ensures that all fields are included in the JSON output, even if they don’t have public access modifiers.
...
public class Message {
   ...
   return (option == JOptionPane.CLOSED_OPTION)?null:responseMessages[option]; 
    ...
    newMessage.put("messageNumber", messageNumber);
    newMessage.put(createdMessageHash, createdMessageHash);
